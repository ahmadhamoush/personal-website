...
{!data.info && !data.projects && !data.skills &&   <Typewriter
  onInit={(typewriter) => {
        ...
        .typeString('BACKDOOR FOUND (23.45.23.12.00000000)' + `<br/>`)
        .typeString('BACKDOOR FOUND (13.66.23.12.00110000)' + `<br/>`)
        ...
        .typeString('SCAN: __ 0100.0000.0554.0080' + `<br/>`)
        .typeString('SCAN: __ 0001.0000.0554.0550' + `<br/>`)
...
{data.info  &&   <Typewriter
  onInit={(typewriter) => {
        ...
        .typeString('EMAIL:' + `<br/>`)
        .typeString('hamoush@outlook.com' + `<br/>`)
        .pause()
      .callFunction(() => {
       setHacking(false)
      })
